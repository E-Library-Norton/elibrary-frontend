...
const contactInfo = [
  ...
  },
  {
    icon: Phone,
    titleKey: "callUs",
    lineKeys: ["phone", "weekdayHours", "sundayHours"],
    color: "text-[#DF900A]",
  ...
  },  
  {
    icon: Mail,
    titleKey: "emailUs",
    lineKeys: ["primaryEmail", "universityEmail"],
    color: "text-[#55B9EA]",
  ...
  {
    icon: Clock,
    titleKey: "libraryHours",
    lineKeys: ["weekdayHoursLabel", "sundayHoursLabel"],
...
const quickLinks = [
  { icon: BookOpen, labelKey: "generalInquiry", subject: "General Inquiry", type: "general" as const },
  { icon: Headphones, labelKey: "technicalSupport", subject: "Technical Support", type: "bug" as const },
  { icon: GraduationCap, labelKey: "academicResources", subject: "Academic Resources", type: "content" as const },
  { icon: Shield, labelKey: "accountIssues", subject: "Account Issues", type: "account" as const },
];

const faqs = [
  {
    questionKey: "faqAccessQuestion",
    answerKey: "faqAccessAnswer",
  },
  {
    questionKey: "faqDownloadQuestion",
    answerKey: "faqDownloadAnswer",
  },
  {
    questionKey: "faqReportQuestion",
    answerKey: "faqReportAnswer",
  },
  {
    questionKey: "faqLimitQuestion",
    answerKey: "faqLimitAnswer",
  },
];
              ...
              >
                ...
                >
                  ...
                  {item.lineKeys.map((lineKey) => (
                    <p key={lineKey} className="text-sm text-[#5E5E5E] dark:text-gray-400 leading-relaxed">
                      {t(lineKey)}
                    </p>
                  ))}
                </div>
                ...
                <div className="relative p-8 rounded-2xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-[#E2E8F0]/60 dark:border-gray-800/60">
                  ...
                  {sent ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-[#1A1A1A] dark:text-gray-300 mb-1.5">
                            {t("fullName")} <span className="text-xs text-gray-400">({t("optional")})</span>
                          </label>
                          <Input
                        ...
                        <div>
                          <label className="block text-sm font-medium text-[#1A1A1A] dark:text-gray-300 mb-1.5">
                            {t("emailAddress")} <span className="text-xs text-gray-400">({t("optional")})</span>
                          </label>
                          <Input
                            type="email"
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          >
                            ...
                            <option value="account">{t("accountHelp")}</option>
                          </select>
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-[#1A1A1A] dark:text-gray-300 mb-1.5">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-[#1A1A1A] dark:text-gray-300 mb-1.5">
                          {t("rateExperience")} <span className="text-xs text-gray-400">({t("optional")})</span>
                        </label>
